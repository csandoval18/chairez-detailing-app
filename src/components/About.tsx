    ...
    <section className="About interior">
      <article className="container">
        ...
        <div className="block">
          <h3>Our Vision</h3>
          <p>
            At Chairez Detailing Services, we believe that every vehicle
            deserves to be treated with the utmost care and attention to detail.
            We envision a future where our expertise and passion for the art of
            detailing continue to elevate the industry, setting a new standard
            of automotive beauty that leaves a lasting impression on every road
            it travels.
          </p>
        </div>
        <div className="block">
          ...
          <p>
            ...
            hand-me-down, he would make sure it was in top shape because,
            "You'll never know who will be in your car, or worse, when they'll
            need to be in it." Bryan refined his detailing skills when he worked
            for Hayes Family Auto, detailing cars as a Car Sales Intern whenever
            things got backed up in the shop.
          </p>
          <p>
